...
public class Football_Script_1 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        actual_tag = PlayerPrefs.GetString("tag_blue", "Not Bought");
    }
    ...
    {
        if (PlayerPrefs.GetInt("Money", 0) >= 100 && football.tag == ("Not Bought"))
        {
            ...
            PlayerPrefs.SetString("tag_blue", "Bought");
